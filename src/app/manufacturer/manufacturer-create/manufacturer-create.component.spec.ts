...
@Component({
  ...
  template: `<div><app-manufacturer-create [manufacturer]="manufacturer"></app-manufacturer-create></div>`
})
...
describe('ManufacturerCreateComponent', () => {
  ...
  it(
    'should create new empty manufacturer.',
    fakeAsync(() => {
      const mf = new Manufacturer(new ManufacturerAttributes());
      console.log(mf);
    })
  );
